...
echo_and_run cd "/home/guilherme/turtlebot-gazebo/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/guilherme/turtlebot-gazebo/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/guilherme/turtlebot-gazebo/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
